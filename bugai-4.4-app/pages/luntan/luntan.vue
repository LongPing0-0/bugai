			...
			<view class="cu-item shadow">
				<view class="cu-list menu-avatar">
					<view class="cu-item">
						...
						<view v-if="item.uid == userInfo.uid ?true:false || userInfo.rid == 4"  class="margin-top-sm flex justify-between">
							<view @click="jinyan(item.uid)" v-if="item.uid !=userInfo.uid && userInfo.rid == 4 && item.communicationEnabled"><button class="cuIcon-voice text-gray"></button></view>
							<view @click="jiechujinyan(item.uid)" v-if="item.uid !=userInfo.uid && userInfo.rid == 4 && item.communicationEnabled == false"><button class="cuIcon-voicefill text-gray"></button></view>
							<view @click="shangchu(item.id)"><button class="cuIcon-delete text-gray"></button></view>
						</view>
					</view>
				</view>
