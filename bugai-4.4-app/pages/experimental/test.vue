  ...
  <view class="container">
    <view class="section">
      ...
      <view class="content">
        ...
        <p>除了判断总体参数的可能范围之外，置信区间还可以用于做出决策或进行推断。例如，在比较两个总体参数时，我们可以根据它们的置信区间来判断它们是否有显著差异。如果两个总体参数的置信区间不重叠，那么它们之间的差异可能是显著的。</p>
      </view>
    </view>
    <view class="section">
					...
					//     },
						...
						methods: {
						    calculateConfidenceInterval() {
							  ...
							  this.confidenceInterval = { lower, upper }
							...
							for (let i = lower - 0.5; i <= upper + 0.5; i += 0.1) {
							  chartData.push({ name: i.toFixed(1), value: jStat.normal.pdf(i, mean, std) *
							  100 })
							  }
